    ...
    private function menu(): array
    {
        return [
            ...
            [
                ...
                'art' => 'pasta',
                'dishes' => [
                    ['ريزوتو فطر · Mushroom Risotto', 'فطر طازة وبارميزان وزبدة · Fresh mushrooms, parmesan and butter', 230, 'rice'],
                    ['ريزوتو فراخ · Chicken Risotto', 'فراخ مشوية وكريمة وأعشاب · Grilled chicken, cream and herbs', 250, 'rice'],
                    ['ريزوتو سي فود · Seafood Risotto', 'جمبري وكالاماري وزعفران · Shrimp, calamari and saffron', 295, 'rice'],
                ],
            ],
            [
            ...
            [
                ...
                'dishes' => [
                    ...
                    ['مشويات مشكلة · Mixed Grill', 'كفتة وريش وشيش طاووق مع أرز وسلطة · Kofta, lamb chops and shish tawook with rice and salad', 450, 'steak'],
                    ['ستيك بصلصة الفطر · Steak with Mushroom Sauce', 'ستيك مشوي بصلصة الفطر والكريمة · Grilled steak in a mushroom cream sauce', 480, 'steak'],
                    ['ريش ضاني مشوية · Grilled Lamb Chops', 'ريش متتبلة بالروزماري مع بطاطس · Rosemary-marinated chops with potatoes', 520, 'steak'],
                ],
            ],
            [
                'name' => 'الحلو · Desserts',
                ...
                'art' => 'dessert',
                'dishes' => [
                    ['آيس كريم · Ice Cream', 'ثلاث كور على اختيارك · Three scoops of your choice', 85, 'icecream'],
                    ['أم علي · Om Ali', 'بالمكسرات والقشطة، تتقدم سخنة · With nuts and cream, served hot', 95],
                    ['كيك الشوكولاتة · Chocolate Cake', 'طبقات كاكاو وصوص شوكولاتة دافي · Cocoa layers with warm chocolate sauce', 110, 'cake'],
                    ...
                    ['تشيز كيك فراولة · Strawberry Cheesecake', 'قاعدة بسكويت وفراولة طازة · Biscuit base with fresh strawberries', 130, 'cake'],
                ],
            ],
            [
                ...
                'art' => 'drink',
                'dishes' => [
                    ['مياه معدنية · Mineral Water', 'زجاجة ٦٠٠ مل · 600 ml bottle', 20, 'bottle'],
                    ['شاي · Tea', 'شاي كشري أو بالنعناع · Plain or with mint', 30, 'hotcup'],
                    ['مشروبات غازية · Soft Drink', 'كانز مثلج · Chilled can', 35],
                    ['إسبريسو · Espresso', 'سنجل أو دوبل · Single or double', 45, 'hotcup'],
                    ['ليموناضة · Lemonade', 'ليمون طازة مثلج · Fresh lemon, served iced', 50, 'juice'],
                    ['عصير ليمون بالنعناع · Lemon & Mint', 'مفروم مع تلج · Blended with ice', 60, 'juice'],
                    ['عصير برتقال · Fresh Orange Juice', 'برتقال طازة متعصر دلوقتي · Oranges squeezed to order', 65, 'juice'],
                    ['كابتشينو · Cappuccino', 'إسبريسو ولبن مخفوق · Espresso with steamed, foamed milk', 65, 'hotcup'],
                    ['لاتيه · Latte', 'إسبريسو مع لبن ساخن · Espresso with hot milk', 70, 'hotcup'],
                    ['عصير مانجو · Mango Juice', 'مانجو طازة في موسمها · Fresh mango, in season', 75, 'juice'],
                    ['موهيتو · Mojito', 'ليمون ونعناع وصودا · Lime, mint and soda', 85, 'juice'],
                ],
            ],
        ];
    }
